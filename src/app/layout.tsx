...
export default function RootLayout({
  ...
  return (
    <html lang="ja">
      <body className="noise-bg min-h-screen bg-[#faf8f5] text-stone-800 antialiased">
        {/* ── 常時背景アニメーション ── */}
        <AmbientBackground />
        <EndRollBackground />
        ...
        {/* ─── フッター ─── */}
        <footer className="relative z-10 overflow-hidden border-t border-stone-200/60 bg-white/60 backdrop-blur-xl safe-bottom">
          {/* 装飾グロー */}
          <div className="absolute -left-32 top-0 h-48 w-48 rounded-full bg-rose-400/[0.06] blur-[80px]" />
          <div className="absolute -right-24 -bottom-12 h-40 w-40 rounded-full bg-amber-400/[0.06] blur-[60px]" />
